...
import EnergyRechargeModule from '@/components/energy-recharge';
...
const CreatePage:React.FC = () => {
  ...
  const customButtons = ()=>{
    if(cur === 'storyboard') {
      return (
        <div className='flexR'>
          <Button type="primary" className="btn-primary-auto btn-primary-150" onClick={()=>setIsEnergyRechargeOpen(true)}>充值能量</Button>
