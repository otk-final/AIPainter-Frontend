...
import { batchDrawColumns } from "./data";

interface BatchDrawTableTRProps {
    data: any,
}

const BatchDrawTableTR:React.FC<BatchDrawTableTRProps> = ({data}) => {
...
export default BatchDrawTableTR