...
import { videoFrom } from "./data"

const GenerateVideoTab = ()=>{
    ...
    const handleAddon = (i:any, type:any)=>{

    }

    const renderSelect = (i:any)=>{
        return (
...
export default GenerateVideoTab