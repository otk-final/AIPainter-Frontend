        ...
        <div className="videogeneration-wrap scrollbar">
            ...
            <div className="section">
                ...
                <div className="form-wrap flexR">
                    <Input size="large" placeholder="ApiKey" value={stateConfiguration.authorization} onChange={(e) => setConfiguration({ ...stateConfiguration, authorization: e.target.value })}  className='input-s ' style={{ width: '900px' }} />
                </div>
            </div>
            ...
            <div className="section">
                ...
                <div className="form-wrap flexR">
                    <div className="form-item flexC">
                        ...
                        <Input size="large" placeholder="ApiKey" value={stateConfiguration.appId} onChange={(e) => setConfiguration({ ...stateConfiguration, appId: e.target.value })}  className='input-s ' style={{ width: '900px' }} />
                    </div>
                </div>
            </div>
        </div>
